...
Na linha 10, vemos o código {x + 10}, o que indica uma tentativa de somar 10 ao valor de x. 
A forma correta de fazer isso seria {x = x + 10} ou {x += 10}.
No entanto, como x foi declarado como uma constante, seu valor não pode ser alterado após a atribuição inicial.
Para corrigir isso, x deve ser declarado como uma variável, utilizando let: {let x = 5;}.
